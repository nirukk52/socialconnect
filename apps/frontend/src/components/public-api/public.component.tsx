...
export const PublicComponent = () => {
  const user = useUser();
  const { appName, backendUrl, frontEndUrl } = useVariables();
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      <div className="flex flex-col">
        ...
        <div className="text-customColor18 mt-[4px]">
          {t(
            ...
            `Use ${appName} API to integrate with your tools.`
          )}
          <br />
          <a
            className="underline hover:font-bold hover:underline"
            href={process.env.NEXT_PUBLIC_APP_DOCS_URL ? `${process.env.NEXT_PUBLIC_APP_DOCS_URL}/public-api` : 'https://docs.postiz.com/public-api'}
            target="_blank"
          >
            {t(
          ...
          >
            <br />
            {t('check_n8n', `Check out our N8N custom node for ${appName}.`)}
          </a>
        </div>
        <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <div className="text-customColor18 mt-[4px]">
          {t(
            ...
            `Connect ${appName} MCP server to your client (Http streaming) to schedule your posts faster.`
          )}
        </div>
        <div className="my-[16px] mt-[16px] bg-sixth border-fifth items-center border rounded-[4px] p-[24px] flex gap-[24px]">
          <div className="flex items-center">
      ...
      <div className="flex flex-col">
        <h3 className="text-[20px]">Building your {appName} payload</h3>
        <div className="text-customColor18 mt-[4px] whitespace-pre-line">
          ...
          We have created an easy way to build your {appName} payload to schedule
          posts. {'\n'}
          You can use the {appName} wizard, and schedule a post with our UI, after
