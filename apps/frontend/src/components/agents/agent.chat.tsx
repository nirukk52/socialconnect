...
export const AgentChat: FC = () => {
  ...
  return (
    <CopilotKit
      ...
      agent={
        (process.env.NEXT_PUBLIC_APP_AGENT_NAME ||
          process.env.APP_AGENT_NAME ||
          (process.env.NEXT_PUBLIC_APP_NAME || process.env.APP_NAME || 'SocialConnect')
            .toLowerCase()
        ...
        <div className="absolute left-0 w-full h-full pb-[20px]">
          <CopilotChat
            ...
            labels={{
              ...
              initial: t('agent_welcome_message', `Hello, I am your SocialConnect agent 🙌🏻.
